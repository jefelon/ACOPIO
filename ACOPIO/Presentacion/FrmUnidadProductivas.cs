...
{
    public partial class FrmUnidadProductivas : Form
    {
        public FrmUnidadProductivas()
        {
            InitializeComponent();
        }

        private void FrmUnidadProductivas_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            FrmUnidadProductiva unipro = new FrmUnidadProductiva();
            unipro.ShowDialog();
            FrmUnidadProductivas_Load(null, null);
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (dgvDatos.CurrentRow.Cells["Id"].Value.ToString() == "1")
                {
                    MessageBox.Show("No se puede borrar/modificar este valor ya que se usa en otros lugares del sistema.");
                }
                else
                {
                    FrmUnidadProductiva color = new FrmUnidadProductiva();
            ...
            if (dgvDatos.CurrentRow != null)
            {
                                   ...
                                   MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
                {
                    ...
                    else
                    {
                        ...
                        unipr.Id = Convert.ToInt32(dgvDatos.CurrentRow.Cells["Id"].Value.ToString());
                        int returnId = FUnidadProductiva.Eliminar(unipr);
                        //if (returnId > 0)
                        //{
                        FrmUnidadProductivas_Load(null, null);
                        //}
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            sfd.FileName = "Unidad-Productivas.xls";
